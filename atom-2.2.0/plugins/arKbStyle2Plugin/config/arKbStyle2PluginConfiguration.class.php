...
class arKbStyle2PluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'Naitonal Library of Sweden AtoM theme. Based on the arDominionPlugin.',
    $version = '0.1.0';
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arKbStyle2Plugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arKbStyle2Plugin/css/main.css', 'last', array('media' => 'all'));
    }
  }
